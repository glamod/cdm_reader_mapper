...
@pytest.mark.parametrize(
    "dname, cdm_name, cdm_subset, codes_subset, suffix, out_path, mapping, mdf_kwargs", 
        [
          ...
          ("063_714", None, None, None, "063_714", None, False, {"sections": ["core", "c99"]}),
          ("069_701", "icoads_r3000_d701_type1", None, None, "069_701_type1", None, True, {}),
          ("069_701", "icoads_r3000_d701_type2", None, None, "069_701_type2", None, True, {}),
          ...
          ("063_714", "icoads_r3000_d714", ["header", "observations-sst"], None, "063_714", None, True, {}),
          ("063_714", "icoads_r3000_d714", None, ["platform_sub_type", "wind_direction"], "063_714", None, True, {}),
          ("063_714", "icoads_r3000_d714", None, None, "063_714", None, True, {"chunksize": 3}),
          ("063_714", "icoads_r3000_d714", None, None, "063_714", None, False, {"sections": ["c99"], "chunksize": 3}), 
    ],
)
def test_read_data(dname, cdm_name, cdm_subset, codes_subset, suffix, out_path, mapping, mdf_kwargs):
    _testing_suite(
